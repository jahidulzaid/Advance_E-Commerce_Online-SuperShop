                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <div class="container"> <img class="d-block img-fluid"
                                                                             src="{{ asset('/') }}admin/assets/images/big/img1.jpg" alt="First slide"></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div class="container"><img class="d-block img-fluid"
                                                                            src="{{ asset('/') }}admin/assets/images/big/img2.jpg" alt="Second slide">
                                                </div>
                                            </div>
                                            <div class="carousel-item">
                                                <div class="container"><img class="d-block img-fluid"
                                                                            src="{{ asset('/') }}admin/assets/images/big/img3.jpg" alt="Third slide"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                ...
                                                <div class="d-flex no-block">
                                                        <span><img src="{{ asset('/') }}admin/assets/images/users/1.jpg" alt="user"
                                            ...
                                            <div class="carousel-item">
                                                <h4 class="cmin-height">My Acting blown <span
                                                    ...
                                                    <br />laugh at the moment</h4>
                                                <div class="d-flex no-block">
                                                        <span><img src="{{ asset('/') }}admin/assets/images/users/2.jpg" alt="user"
                                                                   width="50" class="img-circle"></span>
                                                    <span class="m-l-10">
                                                            <h4 class="text-white m-b-0">Govinda</h4>
                                                            <p class="text-white">Actor</p>
                                            ...
                                            <div class="carousel-item">
                                                <h4 class="cmin-height">My Acting blown <span
                                                    ...
                                                    <br />laugh at the moment</h4>
                                                <div class="d-flex no-block">
                                                        <span><img src="{{ asset('/') }}admin/assets/images/users/3.jpg" alt="user"
                                                                   width="50" class="img-circle"></span>
                                                    <span class="m-l-10">
                                                            <h4 class="text-white m-b-0">Govinda</h4>
                                                            <p class="text-white">Actor</p>
                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets" id="comment" style="height: 629px;position: relative;">
                            ...
                            <div class="d-flex no-block comment-row">
                                <div class="p-2"><span class="round"><img src="{{ asset('/') }}admin/assets/images/users/1.jpg"
                                ...
                                <div class="comment-text w-100">
                                    ...
                                    <div class="comment-footer">
                                        <span class="text-muted pull-right">April 14, 2016</span> <span
                                            class="badge rounded-pill bg-info">Pending</span> <span
                                            class="action-icons">
                            ...
                            <div class="d-flex no-block comment-row border-top">
                                <div class="p-2"><span class="round"><img src="{{ asset('/') }}admin/assets/images/users/2.jpg"
                                                                          alt="user" width="50"></span></div>
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex no-block comment-row border-top">
                                <div class="p-2"><span class="round"><img src="{{ asset('/') }}admin/assets/images/users/3.jpg"
                                                                          alt="user" width="50"></span></div>
                                <div class="comment-text w-100">
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex no-block comment-row border-top">
                                <div class="p-2"><span class="round"><img src="{{ asset('/') }}admin/assets/images/users/4.jpg"
                                                                          alt="user" width="50"></span></div>
                                <div class="comment-text active w-100">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ms-auto">
                                    <button class="pull-right btn btn-circle btn-success text-white"
                                    ...
                                    <li class="list-group-item" data-role="task">
                                        <div class="form-check d-flex align-items-start">
                                            <input type="checkbox" class="form-check-input flex-shrink-0"
                                                   id="customCheck">
                                            <label
                                                class="form-check-label w-100 ms-2 d-md-flex align-items-start font-normal lh-25"
                                                for="customCheck">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and
                                                        typesetting industry. Lorem Ipsum has been</span> <span
                                                    class="badge rounded-pill bg-danger ms-auto mb-2 mb-md-0">Today</span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check d-flex align-items-start">
                                            ...
                                            <label
                                                ...
                                                <span>Lorem Ipsum is simply dummy text of the printing</span><span
                                                    class="badge rounded-pill bg-primary ms-auto mb-2 mb-md-0">1
                                                        week </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check d-flex align-items-start">
                                            ...
                                            <label
                                                ...
                                                <span>Give Purchase report to</span> <span
                                                    class="badge rounded-pill bg-info ms-auto mb-2 mb-md-0">Yesterday</span>
                                            </label>
                                        </div>
                                        <ul class="assignedto">
                                            <li><img src="{{ asset('/') }}admin/assets/images/users/3.jpg" alt="user"
                                    ...
                                    <li class="list-group-item" data-role="task">
                                        <div class="form-check d-flex align-items-start">
                                            ...
                                            <label
                                                ...
                                                for="customCheck1">
                                                <span>Lorem Ipsum is simply dummy text of the printing</span><span
                                                    class="badge rounded-pill bg-warning ms-auto mb-2 mb-md-0">2
                                                        week </span>
                                            </label>
                                        </div>
                                        <div class="item-date"> 26 jun 2017</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="message-box" id="msg" style="height: 430px;position: relative;">
                                <div class="message-widget message-scroll">
                                    <!-- Message -->
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="{{ asset('/') }}admin/assets/images/users/1.jpg" alt="user"
                                    ...
                                    <!-- Message -->
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="{{ asset('/') }}admin/assets/images/users/2.jpg" alt="user"
                                                                    class="img-circle"> <span
                                                class="profile-status busy pull-right"></span> </div>
                                        <div class="mail-contnet">
                                    ...
                                    <!-- Message -->
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="{{ asset('/') }}admin/assets/images/users/4.jpg" alt="user"
                                                                    class="img-circle"> <span
                                                class="profile-status offline pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my
                        ...
                        <div class="card-body">
                            ...
                            <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                                ...
                                <ul class="chat-list">
                                    <!--chat Row -->
                                    <li>
                                        <div class="chat-img"><img src="{{ asset('/') }}admin/assets/images/users/1.jpg" alt="user">
                                        </div>
                                    ...
                                    <!--chat Row -->
                                    <li>
                                        <div class="chat-img"><img src="{{ asset('/') }}admin/assets/images/users/2.jpg" alt="user">
                                        </div>
                                        <div class="chat-content">
                                            <h5>Bianca Doe</h5>
                                    ...
                                    <!--chat Row -->
                                    <li>
                                        <div class="chat-img"><img src="{{ asset('/') }}admin/assets/images/users/3.jpg" alt="user">
                                        </div>
                                        <div class="chat-content">
                ...
                <div class="slimscrollright">
                    ...
                    <div class="r-panel-body">
                        ...
                        <ul class="m-t-20 chatonline">
                            ...
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/1.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Varun Dhavan <small
                                            class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/2.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Genelia Deshmukh <small
                                            class="text-warning">Away</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/3.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Ritesh Deshmukh <small
                                            class="text-danger">Busy</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/4.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Arijit Sinh <small
                                            class="text-muted">Offline</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/5.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Govinda Star <small
                                            class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/6.jpg" alt="user-img"
                                                                  class="img-circle"> <span>John Abraham<small
                                            class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/7.jpg" alt="user-img"
                                                                  class="img-circle"> <span>Hritik Roshan<small
                                            class="text-success">online</small></span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><img src="{{ asset('/') }}admin/assets/images/users/8.jpg" alt="user-img"
